...
const Squid_Game_Quiz = () => {
    ...
    const handleAnswerOptionClick = (isCorrect, index) => {
        ...
        setTimeout(() => {
            ...
            if (nextQuestion < seriesData.squid_game[level].length) {
        ...
        <main>
            ...
            <div className="quiz-container">
                ...
                <div className="question-count">
                    <span>Question {currentQuestion + 1}</span> / {seriesData.squid_game[level].length}
                </div>
                <div className='question-text'>
                    {seriesData.squid_game[level][currentQuestion].question.split('\n').map((line, index) => (
                ...
                {seriesData.squid_game[level][currentQuestion].options.map((option, index) => {
            ...
            <div className="score-section">
                <p>You scored {score} out of {seriesData.squid_game[level].length}</p>
...
export default Squid_Game_Quiz
