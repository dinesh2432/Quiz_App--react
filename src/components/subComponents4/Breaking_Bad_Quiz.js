        ...
        <main>
            ...
            <div className="quiz-container">
                ...
                <div className="question-count">
                    <span>Question {currentQuestion + 1}</span> / {seriesData.breaking_bad[level].length}
                </div>
                <div className='question-text'>
                    {seriesData.breaking_bad[level][currentQuestion].question.split('\n').map((line, index) => (
                ...
                {seriesData.breaking_bad[level][currentQuestion].options.map((option, index) => {
            ...
            <div className="score-section">
                <p>You scored {score} out of {seriesData.breaking_bad[level].length}</p>
...
export default Breaking_Bad_Quiz
