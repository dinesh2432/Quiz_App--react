        ...
        <main>
            ...
            <div className="quiz-container">
                ...
                <div className="question-count">
                    <span>Question {currentQuestion + 1}</span> / {factData.history_mystery[level].length}
                </div>
                <div className='question-text'>
                    {factData.history_mystery[level][currentQuestion].question.split('\n').map((line, index) => (
                ...
                {factData.history_mystery[level][currentQuestion].options.map((option, index) => (
            ...
            <div className="score-section">
                <p>You scored {score} out of {factData.history_mystery[level].length}</p>
...
export default History_Mystories
