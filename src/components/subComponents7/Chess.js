        ...
        <main>
            ...
            <div className="quiz-container">
                ...
                <div className="question-count">
                    <span>Question {currentQuestion + 1}</span> / {sportsData.chess[level].length}
                </div>
                <div className='question-text'>
                    {sportsData.chess[level][currentQuestion].question.split('\n').map((line, index) => (
                ...
                {sportsData.chess[level][currentQuestion].options.map((option, index) => (
            ...
            <div className="score-section">
                <p>You scored {score} out of {sportsData.chess[level].length}</p>
