...
const C__Sharp_Quiz = () => {
    ...
    const handleAnswerOptionClick = (isCorrect, index) => {
        ...
        setTimeout(() => {
            ...
            if (nextQuestion < quizData.c_sharp[level].length) {
      ...
      <main>
        ...
        {!showScore ? (
          <div className="quiz-container">
            <div className="question-section">
              ...
              <div className='question-text'>
                {quizData.c_sharp[level][currentQuestion].question.split('\n').map((line, index) => (
            ...
            <div className="answer-section">
                {quizData.c_sharp[level][currentQuestion].options.map((option, index) => {
          ...
          <div className="score-section">
            <p>You scored {score} out of {quizData.c_sharp[level].length}</p>
