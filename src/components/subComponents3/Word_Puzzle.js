        ...
        <main>
            ...
            <div className="quiz-container">
                ...
                <div className="question-count">
                    <span>Question {currentQuestion + 1}</span> / {puzzleData.word_puzzle[level].length}
                </div>
                <div className='question-text'>
                    {puzzleData.word_puzzle[level][currentQuestion].question.split('\n').map((line, index) => (
                ...
                {puzzleData.word_puzzle[level][currentQuestion].options.map((option, index) => (
            ...
            <div className="score-section">
                <p>You scored {score} out of {puzzleData.word_puzzle[level].length}</p>
