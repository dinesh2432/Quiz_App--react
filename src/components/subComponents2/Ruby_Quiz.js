...
const Ruby_Quiz = () => {
    ...
    const handleback = (e) =>{
        ...
        setTimeout(() => {
            ...
            if (nextQuestion < quizData.ruby[level].length) {
        ...
        <header >
            ...
            <div className="quiz-container">
                ...
                <div className="question-count">
                    <span>Question {currentQuestion + 1}</span> / {quizData.ruby[level].length}
                </div>
                <div className='question-text'>
                    {quizData.ruby[level][currentQuestion].question.split('\n').map((line, index) => (
                ...
                {quizData.ruby[level][currentQuestion].options.map((option, index) => {
            ...
            <div className="score-section">
                <p>You scored {score} out of {quizData.ruby[level].length}</p>
