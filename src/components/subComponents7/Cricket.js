...
const Cricket = () => {
    ...
    const handleAnswerOptionClick = (isCorrect, index) => {
        ...
        setTimeout(() => {
            ...
            if (nextQuestion < sportsData.cricket[level].length) {
        ...
        <main>
            ...
            <div className="quiz-container">
                ...
                <div className="question-count">
                    <span>Question {currentQuestion + 1}</span> / {sportsData.cricket[level].length}
                </div>
                <div className='question-text'>
                    {sportsData.cricket[level][currentQuestion].question.split('\n').map((line, index) => (
                ...
                {sportsData.cricket[level][currentQuestion].options.map((option, index) => {
            ...
            <div className="score-section">
                <p>You scored {score} out of {sportsData.cricket[level].length}</p>
