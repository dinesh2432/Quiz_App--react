        ...
        <main>
            ...
            <div className="quiz-container">
                ...
                <div className="question-count">
                    <span>Question {currentQuestion + 1}</span> / {factData.tech_world[level].length}
                </div>
                <div className='question-text'>
                    {factData.tech_world[level][currentQuestion].question.split('\n').map((line, index) => (
            ...
            <div className="score-section">
                <p>You scored {score} out of {factData.tech_world[level].length}</p>
