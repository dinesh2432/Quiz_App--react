...
const Stranger_things_Quiz = () => {
    ...
    const handleAnswerOptionClick = (isCorrect, index) => {
        ...
        setTimeout(() => {
            ...
            if (nextQuestion < seriesData.stranger_things[level].length) {
        ...
        <main>
            ...
            <div className="quiz-container">
                ...
                <div className="question-count">
                    <span>Question {currentQuestion + 1}</span> / {seriesData.stranger_things[level].length}
                </div>
                <div className='question-text'>
                    {seriesData.stranger_things[level][currentQuestion].question.split('\n').map((line, index) => (
                ...
                {seriesData.stranger_things[level][currentQuestion].options.map((option, index) => {
            ...
            <div className="score-section">
                <p>You scored {score} out of {seriesData.stranger_things[level].length}</p>
...
export default Stranger_things_Quiz
