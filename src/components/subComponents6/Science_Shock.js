...
const Science_Shock = () => {
    ...
    const handleAnswerOptionClick = (isCorrect, index) => {
        ...
        setTimeout(() => {
            ...
            if (nextQuestion < factData.science_shock[level].length) {
        ...
        <main>
            ...
            <div className="quiz-container">
                ...
                <div className="question-count">
                    <span>Question {currentQuestion + 1}</span> / {factData.science_shock[level].length}
                </div>
                <div className='question-text'>
                    {factData.science_shock[level][currentQuestion].question.split('\n').map((line, index) => (
                ...
                {factData.science_shock[level][currentQuestion].options.map((option, index) => {
            ...
            <div className="score-section">
                <p>You scored {score} out of {factData.science_shock[level].length}</p>
