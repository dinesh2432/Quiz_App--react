...
const Hockey = () => {
    ...
    const handleAnswerOptionClick = (isCorrect, index) => {
        ...
        setTimeout(() => {
            ...
            if (nextQuestion < sportsData.hockey[level].length) {
        ...
        <main>
            ...
            <div className="quiz-container">
                ...
                <div className="question-count">
                    <span>Question {currentQuestion + 1}</span> / {sportsData.hockey[level].length}
                </div>
                <div className='question-text'>
                    {sportsData.hockey[level][currentQuestion].question.split('\n').map((line, index) => (
                ...
                {sportsData.hockey[level][currentQuestion].options.map((option, index) => {
            ...
            <div className="score-section">
                <p>You scored {score} out of {sportsData.hockey[level].length}</p>
