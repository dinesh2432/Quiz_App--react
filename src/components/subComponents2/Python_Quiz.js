...
const Python_Quiz = () => {
    ...
    const handleAnswerOptionClick = (isCorrect, index) => {
        ...
        setTimeout(() => {
            ...
            if (nextQuestion < quizData.python[level].length) {
        ...
        <main>
            ...
            <div className="quiz-container">
                ...
                <div className="question-count">
                    <span>Question {currentQuestion + 1}</span> / {quizData.python[level].length}
                </div>
                <div className='question-text'>
                    {quizData.python[level][currentQuestion].question.split('\n').map((line, index) => (
                ...
                {quizData.python[level][currentQuestion].options.map((option, index) => {
            ...
            <div className="score-section">
                <p>You scored {score} out of {quizData.python[level].length}</p>
