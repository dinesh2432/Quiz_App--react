        ...
        <main>
            ...
            <div className="quiz-container">
                ...
                <div className="question-count">
                    <span>Question {currentQuestion + 1}</span> / {detectiveData.deduction_puzzle[level].length}
                </div>
                <div className='question-text'>
                    {detectiveData.deduction_puzzle[level][currentQuestion].question.split('\n').map((line, index) => (
                ...
                {detectiveData.deduction_puzzle[level][currentQuestion].options.map((option, index) => {
            ...
            <div className="score-section">
                <p>You scored {score} out of {detectiveData.deduction_puzzle[level].length}</p>
