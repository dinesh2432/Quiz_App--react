...
const GOT_Quiz = () => {
    ...
    const handleAnswerOptionClick = (isCorrect, index) => {
        ...
        setTimeout(() => {
            ...
            if (nextQuestion < seriesData.game_of_thrones[level].length) {
        ...
        <main>
            ...
            <div className="quiz-container">
                ...
                <div className="question-count">
                    <span>Question {currentQuestion + 1}</span> / {seriesData.game_of_thrones[level].length}
                </div>
                <div className='question-text'>
                    {seriesData.game_of_thrones[level][currentQuestion].question.split('\n').map((line, index) => (
                ...
                {seriesData.game_of_thrones[level][currentQuestion].options.map((option, index) => {
            ...
            <div className="score-section">
                <p>You scored {score} out of {seriesData.game_of_thrones[level].length}</p>
