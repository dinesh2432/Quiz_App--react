...
const Crime_scene_quiz = () => {
    ...
    const handleAnswerOptionClick = (isCorrect, index) => {
        ...
        setTimeout(() => {
            ...
            // Note: Fixed bug using deduction_puzzle instead of crime_analysis in original code
            if (nextQuestion < detectiveData.crime_analysis[level].length) {
        ...
        <main>
            ...
            <div className="quiz-container">
                ...
                <div className="question-count">
                    <span>Question {currentQuestion + 1}</span> / {detectiveData.crime_analysis[level].length}
                </div>
                <div className='question-text'>
                    {detectiveData.crime_analysis[level][currentQuestion].question.split('\n').map((line, index) => (
                ...
                {detectiveData.crime_analysis[level][currentQuestion].options.map((option, index) => {
            ...
            <div className="score-section">
                <p>You scored {score} out of {detectiveData.crime_analysis[level].length}</p>
...
export default Crime_scene_quiz
