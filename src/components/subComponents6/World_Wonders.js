...
const World_Wonders = () => {
    ...
    const handleAnswerOptionClick = (isCorrect, index) => {
        ...
        setTimeout(() => {
            ...
            if (nextQuestion < factData.world_wonders[level].length) {
        ...
        <main>
            ...
            <div className="quiz-container">
                ...
                <div className="question-count">
                    <span>Question {currentQuestion + 1}</span> / {factData.world_wonders[level].length}
                </div>
                <div className='question-text'>
                    {factData.world_wonders[level][currentQuestion].question.split('\n').map((line, index) => (
                ...
                {factData.world_wonders[level][currentQuestion].options.map((option, index) => {
            ...
            <div className="score-section">
                <p>You scored {score} out of {factData.world_wonders[level].length}</p>
