...
const Rust_Quiz = () => {
  ...
  const handleAnswerOptionClick = (isCorrect, index) => {
        ...
        setTimeout(() => {
            ...
            if (nextQuestion < quizData.rust[level].length) {
    ...
    <div className={`c_quiz ${isc_quiz ? "c_quiz" : ""}`}>
        ...
        {!showScore ? (
          <div className="quiz-container">
            <div className="question-section">
              <div className="question-count">
                <span>Question {currentQuestion + 1}</span> / {quizData.rust[level].length}
              </div>
              <div className='question-text'>
                {quizData.rust[level][currentQuestion].question.split('\n').map((line, index) => (
            ...
            <div className="answer-section">
                {quizData.rust[level][currentQuestion].options.map((option, index) => {
          ...
          <div className="score-section">
            <p>You scored {score} out of {quizData.rust[level].length}</p>
