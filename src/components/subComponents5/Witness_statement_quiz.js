...
const Witness_statement_quiz = () => {
    ...
    const handleAnswerOptionClick = (isCorrect, index) => {
        ...
        setTimeout(() => {
            ...
            if (nextQuestion < detectiveData.witness_statement[level].length) {
        ...
        <main>
            ...
            <div className="quiz-container">
                ...
                <div className="question-count">
                    <span>Question {currentQuestion + 1}</span> / {detectiveData.witness_statement[level].length}
                </div>
                <div className='question-text'>
                    {detectiveData.witness_statement[level][currentQuestion].question.split('\n').map((line, index) => (
                ...
                {detectiveData.witness_statement[level][currentQuestion].options.map((option, index) => {
            ...
            <div className="score-section">
                <p>You scored {score} out of {detectiveData.witness_statement[level].length}</p>
...
export default Witness_statement_quiz
