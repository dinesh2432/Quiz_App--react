...
const Pattern_Identification_quiz = () => {
        ...
        <main>
            ...
            <div className="quiz-container">
                ...
                <div className="question-count">
                    <span>Question {currentQuestion + 1}</span> / {detectiveData.pattern_solving[level].length}
                </div>
                <div className='question-text'>
                    {detectiveData.pattern_solving[level][currentQuestion].question.split('\n').map((line, index) => (
            ...
            <div className="score-section">
                <p>You scored {score} out of {detectiveData.pattern_solving[level].length}</p>
...
export default Pattern_Identification_quiz
