...
const Human_Fact = () => {
    ...
    const handleAnswerOptionClick = (isCorrect, index) => {
        ...
        setTimeout(() => {
            ...
            if (nextQuestion < factData.human_facts[level].length) {
        ...
        <main>
            ...
            <div className="quiz-container">
                ...
                <div className="question-count">
                    <span>Question {currentQuestion + 1}</span> / {factData.human_facts[level].length}
                </div>
                <div className='question-text'>
                    {factData.human_facts[level][currentQuestion].question.split('\n').map((line, index) => (
                ...
                {factData.human_facts[level][currentQuestion].options.map((option, index) => {
            ...
            <div className="score-section">
                <p>You scored {score} out of {factData.human_facts[level].length}</p>
