...
const Javascript_Quiz = () => {
    ...
    const handleAnswerOptionClick = (isCorrect, index) => {
        ...
        setTimeout(() => {
            ...
            if (nextQuestion < quizData.javascript[level].length) {
        ...
        <main>
            ...
            <div className="quiz-container">
                ...
                <div className="question-count">
                    <span>Question {currentQuestion + 1}</span> / {quizData.javascript[level].length}
                </div>
                <div className='question-text'>
                    {quizData.javascript[level][currentQuestion].question.split('\n').map((line, index) => (
                ...
                {quizData.javascript[level][currentQuestion].options.map((option, index) => {
            ...
            <div className="score-section">
                <p>You scored {score} out of {quizData.javascript[level].length}</p>
